...
System.register('app/repo', ['npm:babel-runtime@5.8.25/helpers/get', 'npm:babel-runtime@5.8.25/helpers/inherits', 'npm:babel-runtime@5.8.25/helpers/create-class', 'npm:babel-runtime@5.8.25/helpers/class-call-check', 'npm:react@0.14.0'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, Repo;
...
System.register('app/repo_list', ['npm:babel-runtime@5.8.25/helpers/get', 'npm:babel-runtime@5.8.25/helpers/inherits', 'npm:babel-runtime@5.8.25/helpers/create-class', 'npm:babel-runtime@5.8.25/helpers/class-call-check', 'npm:react@0.14.0', 'app/api', 'app/repo'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, reposForUser, Repo, RepoList;
  ...
  return {
    ...
    execute: function () {
      ...
      RepoList = (function (_React$Component) {
        _inherits(RepoList, _React$Component);

        function RepoList(props) {
          _classCallCheck(this, RepoList);

          _get(Object.getPrototypeOf(RepoList.prototype), 'constructor', this).call(this, props);
          this.state = { repos: [] };
        }
        ...
        _createClass(RepoList, [{
          ...
          value: function componentDidMount() {
            ...
            reposForUser('zaiste').then(function (repos) {
      ...
      _export('default', RepoList);
    }
  };
});
System.register('app/main', ['npm:babel-runtime@5.8.25/helpers/get', 'npm:babel-runtime@5.8.25/helpers/inherits', 'npm:babel-runtime@5.8.25/helpers/create-class', 'npm:babel-runtime@5.8.25/helpers/class-call-check', 'npm:whatwg-fetch@0.9.0', 'npm:react@0.14.0', 'npm:react-dom@0.14.0', 'app/repo_list'], function (_export) {
  var _get, _inherits, _createClass, _classCallCheck, React, ReactDOM, RepoList, App;
  ...
  return {
    setters: [function (_npmBabelRuntime5825HelpersGet) {
      ...
      _classCallCheck = _npmBabelRuntime5825HelpersClassCallCheck['default'];
    }, function (_npmWhatwgFetch090) {}, function (_npmReact0140) {
      React = _npmReact0140['default'];
    }, function (_npmReactDom0140) {
      ReactDOM = _npmReactDom0140['default'];
    }, function (_appRepo_list) {
      RepoList = _appRepo_list['default'];
    }],
    execute: function () {
      'use strict';
